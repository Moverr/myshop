    ...
    */
    ...
    $deadline_submission= '';
    $documents_address_delivered_to = '';
  ...
  #  print_r($formdata);
    ...
    -->
                  ...
                  <div class="row-fluid disposal_records">
                        ...
                        <div class="row-fluid">
                         <div class="control-group   <?=(in_array('disposal_ref_no', $requiredfields)? 'error': '')?>  ">
                           <label class="control-label">Disposal Reference Number  </label>
                         <div class="controls">
                <div class="input-append" >
                <input
                
                 name="disposal_ref_no"  
                class="disposal_ref_no" 
                id="disposal_ref_no" 
                type="text" value="<?=!empty($formdata['disposal_ref_no']) ?$formdata['disposal_ref_no']: !empty($formdata['disposal_ref_no']) ? $formdata['disposal_ref_no'] : '' ?>">
                ...
                <span class="add-on"><i class="fa fa-calendar"></i></span>
                        ...
                        <div class="row-fluid">
                            <div class="control-group <?=(in_array('bid_document_issue_date', $requiredfields)? 'error': '')?>  ">
                                <label class="control-label">Publish Bid Notice </label>
                                <div class="controls   ">
                                    <div class="input-append date date-picker" data-date="<?=date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd" data-date-viewmode="days">
...
<?=!empty($formdata['documents_inspection_address']) ?$formdata['documents_inspection_address']:'' ?>
            ...
            <!-- inspect Opening Date -->
                        ...
                        <div class="control-group <?=(in_array('inspect_openning_date', $requiredfields) || in_array('inspect_openning_date', $requiredfields)? 'error': '')?>">
                            ...
                            <div class="controls">
                                ...
                                <div class="input-append bootstrap-timepicker-component">
                                    ...
                                    <input id="inspect_openning_date_time" name="inspect_openning_date_time" class="input-mini m-ctrl-small timepicker-default" value="<?=!empty($formdata['inspect_openning_date_time']) ? custom_date_format('H:i',$formdata['inspect_openning_date_time']):'' ?>" type="text" />
                        ...
                        <div class="control-group <?=(in_array('inspect_close_date', $requiredfields) || in_array('inspect_close_date', $requiredfields)? 'error': '')?>">
                            ...
                            <div class="controls">
                                ...
                                <div class="input-append bootstrap-timepicker-component">
                                    ...
                                    <input id="inspect_close_date_time" name="inspect_close_date_time" class="input-mini m-ctrl-small timepicker-default" value="<?=!empty($formdata['inspect_close_date_time']) ? custom_date_format('H:i',$formdata['inspect_close_date_time']):'' ?>" type="text" />
                                    <span class="add-on"><i class="fa fa-clock-o"></i></span>
                        ...
                        <div class="control-group <?=(in_array('non_refundable_fee', $requiredfields)? 'error': '')?>">
                            <label class="control-label">Price of Bidding Documents :<span>*</span></label>
                            <div class="controls">
                                <div class="input-append ">
...
&nbsp; &nbsp;                                     <select class="input-small   currency" data-placeholder="Currency" id="currency" name="currency" tabindex="1">
                                               <?php
                                                foreach($cur as $record){
                                                  ...
                                                  ?>
                                                  <option value="<?=$record['id']; ?>" <?=(trim($record['title']) =="UGX") ? 'selected' : '' ; ?> ><?php print_r($record['title']); ?> </option>
                                                  <?php
                                                  }
                                                  ?>
                                        </select>   
                        ...
                        <!-- Address Where bids will Issued From   -->
                        <div class="control-group <?=(in_array('documents_address_issue', $requiredfields)? 'error': '')?>">
                            <label class="control-label">Documents Will be Issued From :<span>*</span></label>
                            <div class="controls">
                                <textarea rows="3" name="documents_address_issue" id="documents_address_issue" class="input-xxlarge">
...
<?=!empty($formdata['documents_address_issue']) ?$formdata['documents_address_issue']:'' ?>
                         ...
                         <!-- Bids Submission  Address-->
                        <div class="control-group <?=(in_array('documents_address_delivered_to', $requiredfields)? 'error': '')?>">
                            <label class="control-label">Documents Will BE Delivered  to  <span>*</span></label>
                            <div class="controls">
                                <textarea rows="3" name="documents_address_delivered_to" id="documents_address_delivered_to" class="input-xxlarge">
                                    
                                        <?=!empty($formdata['documents_address_delivered_to']) ?$formdata['documents_address_delivered_to']:'' ?>
                                </textarea>
                                    <span>
                                    <input type="checkbox" name="same_as_above" id="same_as_issed_from" value="same" />
                                    <label for="same_as_inspection" style="display:inline">
                                        Tick if same as above or state
                                    </label>
                                    </span>
                        ...
                        <div class="control-group <?=(in_array('documents_address_issue', $requiredfields)? 'error': '')?>">
                            ...
                            <div class="controls">
                                <textarea rows="3" name="bid_opening_address" id="bid_opening_address" class="input-xxlarge">                                   
                        ...
                        <div class="control-group <?=(in_array('bid_opening_date', $requiredfields) ? 'error': '')?>">
                            <label class="control-label">Bid opening date:<span>*</span></label>
                            <div class="controls">
                                <div class="input-append date date-picker" data-date="<?=(!empty($formdata['bid_opening_date'])? display_date( $formdata['bid_opening_date']) : date('Y-m-d') )?>" data-date-format="yyyy-mm-dd" data-date-viewmode="days">
                                    <input id="bid_opening_date" name="bid_opening_date" data-date="<?=(!empty($bid_opening_date )? $bid_opening_date : date('Y-m-d') )?>" data-date-format="yyyy-mm-dd" data-date-viewmode="days" class=" m-ctrl-medium date-picker bid_openning_date" type="text" value="<?=!empty($formdata['bid_opening_date']) ?$formdata['bid_opening_date']:'' ?>" />
                                    <span class="add-on"><i class="fa fa-calendar"></i></span>
                                    <button type="button" onClick="javascript:$('#bid_openning_date').attr('value','');"><i class='fa fa-refresh'></i> </button>
                                ...
                                <div class="input-append bootstrap-timepicker-component">
                                    ...
                                    <input id="bid_openning_date_time" name="bid_openning_date_time" class="input-mini m-ctrl-small timepicker-default" value="<?=!empty($formdata['bid_openning_date_time']) ?$formdata['bid_openning_date_time']:'' ?>" type="text" />
                                    <span class="add-on"><i class="fa fa-clock-o"></i></span>
