...
class Pde_m extends MY_Model
{
    ...
    function get_active_pdes($category = '')
    {

        $this->db->cache_on();
        $this->db->distinct('P.pdeid');
...
//        exit;
    ...
    */
    ...
    #search pdes
    function search_pdes($status,$data,$search_string = '')
    {
        $result = paginate_list($this, $data, 'fetchpdes', array('STATUS'=>$status, 'orderby'=>' ORDER BY create_date ' ,'searchstring'=> $search_string),200);
