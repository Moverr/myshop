...
<div class="widget">
    <div class="widget-title">
        <h4><i class="fa fa-reorder"></i>&nbsp;Manage  Items </h4>
            <span class="tools">
...
foreach($list['page_list'] as $key => $row)
{
	...
	<tr  >
		...
		<td>
						 <a href="<?=base_url().'items/additem/i/'.base64_encode($row['id']); ?>"> <i class="fa fa-edit"></i></a>
						 <a href="#" data-url="<?=base_url().'items/verify/action/deleteitem';?>" delete_category" id="deleteitem_<?=$row['id'];?>" class="savedelpde"> 
						...
						?>
							...
							<?=custom_date_format('Y -M-d',$row['date_added']); ?>
						</td>
