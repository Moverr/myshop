                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-md-8 column" style="border-left:1px solid #ddd;">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-md-5 column">
                                                <button type="button" class="btn btn-default  " style="font-size:12px; font-weight:bold;" onClick="javascript:location.reload(0);"><i class="fa fa-list"></i> List Items</button>
                                            </div>
