...
<div class="clearfix content-wrapper tabbable" style="padding-top:28px;">
    ...
    <?php
    if(!empty($view_to_load) && ($view_to_load == 'notice') )
    {
        $this->load->view("public/disposal_notice_details");
    }
    else{
    ?>
    <div class="col-md-12" style="margin:0 auto">
            ...
            <div class="col-md-13 column content-area">
                ...
                <div class="col-md-13 column content-area">
                    <div class="page-header col-lg-offset-2" style="margin:0px 0px">
                        <div class=" page-header col-lg-offset-2 searchengine" style="margin:0px 0px" dataurl="<?=base_url()."page/search_disposal_notices"; ?>">
                            ...
                            <div class="row content">
                                <div class="col-md-13 column form-group searchcontent">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-md-12 column" style="border-left:1px solid #ddd;">
                                            ...
                                            <div class="row ">
                                                <div class="col-md-5 column">
                                                    <select   dataattr="disposing_method" class="col-md-12 form-control disposing_method" id="disposing_methodadv"  >
                                                      <?php     $disposaltype = fetch_disposal_methods();
                                                ?>
 ...
 <a class="pull-right  btn btn-sm btn-danger"
                       href="<?= base_url() . 'page/disposal_notices/level/export' ?>">Export This Page</a>
