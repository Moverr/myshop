...
<script>
    $(function(){
        ...
        searchdata = {};
        $(".searchengine").on('change','.procurement_entity,.procurement_type,.subjectof_procurement,.subjectof_procurement,.procurement_method,.procurement_entityadv,.sourceof_funding,.financial_year,.contracts_status,.service_providers,.simplesearch',function(){
