...
<div class="col-md-13 column content-area">
    ...
    <div class=" page-header col-lg-offset-2 searchengine" style="margin:0px 0px" dataurl="<?=base_url()."page/search_published_lbas"; ?>">
    ...
    <div class="row clearfix">
             ...
             <div class="col-md-4 column " style="padding-left:20px;">
                <h3>Letters of Bid Acceptance </h3>
              </div>
